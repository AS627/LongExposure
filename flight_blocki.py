...
if __name__ == '__main__':
    ...
    client.move(0.21973094170403587, 0.725, .35, 0.0, 0.5)
    client.move_smooth([0.21973094170403587, 0.725, .35], [0.21973094170403587, 0.26875, 0.35], 0.0, 0.1)
    client.move(0.21973094170403587, 0.26875, .35, 0.0, 0.5)
    client.move_smooth([0.21973094170403587, 0.26875, .35], [0.0, 0.25625, 0.35], 0.0, 0.1)
    client.move(0.0, 0.25625, .35, 0.0, 0.5)
    client.move_smooth([0.0, 0.25625, .35], [0.0, 0.0, 0.35], 0.0, 0.1)
    client.move(0.0, 0.0, .35, 0.0, 0.5)
    client.move_smooth([0.0, 0.0, .35], [1.0, 0.003125, 0.35], 0.0, 0.1)
    client.move(1.0, 0.003125, .35, 0.0, 0.5)
    client.move_smooth([1.0, 0.003125, .35], [1.0, 0.259375, 0.35], 0.0, 0.1)
    client.move(1.0, 0.259375, .35, 0.0, 0.5)
    client.move_smooth([1.0, 0.259375, .35], [0.7757847533632287, 0.26875, 0.35], 0.0, 0.1)
    client.move(0.7757847533632287, 0.26875, .35, 0.0, 0.5)
    client.move_smooth([0.7757847533632287, 0.26875, .35], [0.7757847533632287, 0.725, 0.35], 0.0, 0.1)
    client.move(0.7757847533632287, 0.725, .35, 0.0, 0.5)
    client.move_smooth([0.7757847533632287, 0.725, .35], [1.0, 0.740625, 0.35], 0.0, 0.1)
    client.move(1.0, 0.740625, .35, 0.0, 0.5)
    client.move_smooth([1.0, 0.740625, .35], [1.0, 0.996875, 0.35], 0.0, 0.1)
    client.move(1.0, 0.996875, .35, 0.0, 0.5)
    client.move_smooth([1.0, 0.996875, .35], [0.0, 1.0, 0.35], 0.0, 0.1)
    client.move(0.0, 1.0, .35, 0.0, 0.5)

    client.move_smooth([0.0, 1.0, .35], [0.0, 1.0, 0.15], 0.0, 0.2)
    client.move(0.0, 0.0, 0.15, 0.0, 0.5)
